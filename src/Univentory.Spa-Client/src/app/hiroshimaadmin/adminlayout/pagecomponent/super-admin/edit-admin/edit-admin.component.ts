...
export class EditAdminUserComponent extends LanguageHandlerService implements OnInit {
    ...
    /**
    * To update new admin information
    * @example
    * save()
    ...
    */
    save(): void {
        ...
        this._admin_service.UpdateAdmin(this.adminUserForm.value, currentUser.id)
            .pipe(first())
            .subscribe(response => {
                if (!response.success)
